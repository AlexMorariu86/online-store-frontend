          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-xs mx-auto mt-20 relative">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-2">
                <button className="bg-black border border-gray-300 rounded-lg py-2">7.5</button>
                <button className="bg-black border border-gray-300 rounded-lg py-2">7.75</button>
                <button className="bg-black border border-gray-300 rounded-lg py-2">7.8</button>
                <button className="bg-black border border-gray-300 rounded-lg py-2">8.0</button>
                <button className="bg-black border border-gray-300 rounded-lg py-2">8.25</button>
                <button className="bg-black border border-gray-300 rounded-lg py-2">8.5</button>
              </div>
            </div>
          </div>
        </div>
